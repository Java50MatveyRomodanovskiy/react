...
export const ShoppingCart: React.FC = () => {
    ...
    function getColumn(p: ShoppingProductType, i: number): ShoppingCartType {
        ...
        if (curProd){
        curItem = {id: i +'', title: curProd!.title, category: curProd!.category, unit: curProd!.category, cost: curProd!.cost, image: curProd!.image, count: p.count, sum: curProd!.cost * p.count}
        } 
